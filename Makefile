...
GOLDFLAGS += -X 'github.com/theQRL/qrl-testnet-testing-tool/pkg/coordinator/buildinfo.BuildVersion="$(VERSION)"'
GOLDFLAGS += -X 'github.com/theQRL/qrl-testnet-testing-tool/pkg/coordinator/buildinfo.BuildRelease="$(RELEASE)"'
