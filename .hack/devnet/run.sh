...
if kurtosis enclave inspect "$ENCLAVE_NAME" > /dev/null; then
  ...
  kurtosis run github.com/theQRL/qrl-package --enclave "$ENCLAVE_NAME" --args-file "$args_file" --non-blocking-tasks --image-download always

  # Stop assertoor instance within qrl-package if running
